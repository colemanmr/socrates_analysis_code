...
file_soc_toa_lw = file_loc.diag_dir + '/socrates_diags/bc_prp_1year_clear_sky_cont_20140701_toa_lw.nflx'
file_soc_toa_sw = file_loc.diag_dir + '/socrates_diags/bc_prp_1year_clear_sky_cont_20140701_toa_sw.nflx'
...
# socrates plot
plt.figure()
plt.title('SOCRATES TOA net down flux 20140701 prp bc demo cont case clear')
mesh = iplt.pcolormesh(soc_toa_net, vmin = -250, vmax = 250, cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_flux_toa_map_20140701_soc_prp_bc_demo_cont_case_clear.png', dpi = 300)
plt.show()

# socrates plot sw
plt.figure()
plt.title('SOCRATES TOA sw net down flux 20140701 prp bc demo cont case clear')
mesh = iplt.pcolormesh(soc_toa_sw, vmin = 0, vmax = 450, cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'sw_down_flux_toa_map_20140701_soc_prp_bc_demo_cont_case_clear.png', dpi = 300)
plt.show()

# socrates plot lw
plt.figure()
plt.title('SOCRATES TOA lw net down flux 20140701 prp bc demo cont case clear')
mesh = iplt.pcolormesh(soc_toa_lw, vmin = -400, vmax = -50, cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'lw_down_flux_toa_map_20140701_soc_prp_bc_demo_cont_case_clear.png', dpi = 300)
plt.show()
    
# difference plot
plt.figure()
plt.title('TOA net down flux 20140701 Socrates - UKESM prp bc demo cont case clear')
mesh = iplt.pcolormesh(net_diff, vmin = -1, vmax = 1, cmap = 'seismic')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_flux_toa_map_20140701_soc-ukesm_prp_bc_demo_cont_case_clear.png', dpi = 300)
plt.show()

# sw difference plot
plt.figure()
plt.title('TOA sw net down flux 20140701 Socrates - UKESM prp bc demo cont case clear')
mesh = iplt.pcolormesh(net_diff_sw, vmin = -1, vmax = 1, cmap = 'seismic')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_sw_flux_toa_map_20140701_soc-ukesm_prp_bc_demo_cont_case_clear.png', dpi = 300)
plt.show()

# lw difference plot
plt.figure()
plt.title('TOA lw net down flux 20140701 Socrates - UKESM prp bc demo cont case clear')
mesh = iplt.pcolormesh(net_diff_lw, vmin = -1, vmax = 1, cmap = 'seismic')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_lw_flux_toa_map_20140701_soc-ukesm_prp_bc_demo_cont_case_clear.png', dpi = 300)
plt.show()
