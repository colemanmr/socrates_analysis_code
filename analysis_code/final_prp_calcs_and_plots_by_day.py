...
def calc_socrates_prp(band, yearmonthday):
    """
    ...
    diag_dir = file_loc.diag_dir + \
        'socrates_diags/bc_prp_1year_clear_sky/day_mean_fluxes/'
    ...
    for case in cases: 
        ...
        filename = diag_dir + 'bc_prp_1year_clear_sky_' + case + '_' + \
            yearmonthday + '_mean_toa_' + band + '.nflx'
...
# do PRP calculations
sw_diffs, sw_two_sided_diffs = calc_socrates_prp('sw', '20141009')
lw_diffs, lw_two_sided_diffs = calc_socrates_prp('lw', '20141009')
