...
file_soc_surf_sw_down = file_loc.diag_dir + '/socrates_diags/cd964_20140529_1-above-surf_sw_clearclean_sky_szen_fix.vflx'
file_soc_surf_lw_down = file_loc.diag_dir + '/socrates_diags/cd964_20140529_1-above-surf_lw_clearclean_sky_szen_fix.dflx'

file_soc_toa_sw_down = file_loc.diag_dir + '/socrates_diags/cd964_20140529_toa_sw_clearclean_sky_szen_fix.vflx'
file_soc_toa_lw_down = file_loc.diag_dir + '/socrates_diags/cd964_20140529_toa_lw_clearclean_sky_szen_fix.dflx'
file_soc_toa_lw_up = file_loc.diag_dir + '/socrates_diags/cd964_20140529_toa_lw_clearclean_sky_szen_fix.uflx'
...
soc_toa_sw_down_raw = iris.load_cube(file_soc_toa_sw_down)
soc_toa_lw_down_raw = iris.load_cube(file_soc_toa_lw_down)
soc_toa_lw_up_raw = iris.load_cube(file_soc_toa_lw_up)
...
soc_toa_sw_down = soc_toa_sw_down_raw[0,:,:] 
soc_toa_lw_down = soc_toa_lw_down_raw[0,:,:] 
soc_toa_lw_up = soc_toa_lw_up_raw[0,:,:] 
...
soc_toa_sw_down.units = 'W m-2'
soc_toa_lw_down.units = 'W m-2'
soc_toa_lw_up.units = 'W m-2'
...
soc_toa_sw_down.remove_coord('longitude')
soc_toa_sw_down.remove_coord('latitude')
soc_toa_sw_down.add_dim_coord(ukesm_longitude, 1)
soc_toa_sw_down.add_dim_coord(ukesm_latitude, 0)

soc_toa_lw_down.remove_coord('longitude')
soc_toa_lw_down.remove_coord('latitude')
soc_toa_lw_down.add_dim_coord(ukesm_longitude, 1)
soc_toa_lw_down.add_dim_coord(ukesm_latitude, 0)

soc_toa_lw_up.remove_coord('longitude')
soc_toa_lw_up.remove_coord('latitude')
soc_toa_lw_up.add_dim_coord(ukesm_longitude, 1)
soc_toa_lw_up.add_dim_coord(ukesm_latitude, 0)
...
# Difference the soc and ukesm surf - toa down fluxes to check atmos absorption
soc_atmos_abs_sw = soc_surf_sw_down - soc_toa_sw_down
ukesm_atmos_abs_sw = ukesm_down_sw[1] - ukesm_down_sw[85]
diff_atmos_abs_sw = soc_atmos_abs_sw - ukesm_atmos_abs_sw

soc_atmos_abs_lw = soc_surf_lw_down - soc_toa_lw_down
ukesm_atmos_abs_lw = ukesm_down_lw[1] - ukesm_down_lw[85]
diff_atmos_abs_lw = soc_atmos_abs_lw - ukesm_atmos_abs_lw


# # Difference soc and ukesm TOA up/surf up for atmos absorption unaffected by albedo
# soc_atmos_abs_lw_ratio = soc_toa_lw_up/soc_surf_lw_up
# ukesm_atmos_abs_lw_ratio = ukesm_up_lw[85]/ukesm_up_lw[0]
# diff_atmos_abs_lw_ratio = soc_atmos_abs_lw_ratio - ukesm_atmos_abs_lw_ratio
...
# soc atmos abs plot
plt.figure()
plt.title('sw 1-above-surf minus TOA down 20140529 Socrates szen fix clearclean')
mesh = iplt.pcolormesh(soc_atmos_abs_sw,\
                           vmin = -140, vmax = 0,\
                       cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
...
plt.savefig(plot_dir + 'sw_flux_down_1-above-surf_minus_toa_map_20140529_soc_szen_fix_clearclean.png', dpi = 300)
plt.show()

# ukesm atmos abs plot
plt.figure()
plt.title('sw 1-above-surf minus TOA down 20140529 UKESM szen fix clearclean')
mesh = iplt.pcolormesh(ukesm_atmos_abs_sw,\
                           vmin = -140, vmax = 0,\
                       cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
...
plt.savefig(plot_dir + 'sw_flux_down_1-above-surf_minus_toa_map_20140529_ukesm_szen_fix_clearclean.png', dpi = 300)
plt.show()

# soc-ukesm atmos abs plot
plt.figure()
plt.title('sw 1-above-surf minus TOA down 20140529 Socrates-UKESM szen fix clearclean')
mesh = iplt.pcolormesh(diff_atmos_abs_sw,\
                           vmin = -1.5, vmax = 1.5,\
                       cmap = 'seismic')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
...
plt.savefig(plot_dir + 'sw_flux_down_1-above-surf_minus_toa_map_20140529_soc_minus_ukesm_szen_fix_clearclean.png', dpi = 300)
plt.show()
...
# plt.figure()
# plt.title('lw 1-above-surf minus TOA down 20140529 Socrates szen fix clearclean')
# mesh = iplt.pcolormesh(soc_atmos_abs_lw,\
#                            # vmin = -140, vmax = 0,\
#                        cmap = 'viridis')
# plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
#                   orientation = 'horizontal',
#                     #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
#                   )
# plt.savefig(plot_dir + 'lw_flux_down_1-above-surf_minus_toa_map_20140529_soc_szen_fix_clearclean.png', dpi = 300)
# plt.show()

# # ukesm atmos abs plot
# plt.figure()
# plt.title('lw 1-above-surf minus TOA down 20140529 UKESM szen fix clearclean')
# mesh = iplt.pcolormesh(ukesm_atmos_abs_lw,\
#                            # vmin = -140, vmax = 0,\
#                        cmap = 'viridis')
# plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
#                   orientation = 'horizontal',
#                     #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
#                   )
# plt.savefig(plot_dir + 'lw_flux_down_1-above-surf_minus_toa_map_20140529_ukesm_szen_fix_clearclean.png', dpi = 300)
# plt.show()

# # soc-ukesm atmos abs plot
# plt.figure()
# plt.title('lw 1-above-surf minus TOA down 20140529 Socrates-UKESM szen fix clearclean')
# mesh = iplt.pcolormesh(diff_atmos_abs_lw,\
#                            # vmin = -1.5, vmax = 1.5,\
#                        cmap = 'seismic')
# plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
#                   orientation = 'horizontal',
#                     #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
#                   )
# plt.savefig(plot_dir + 'lw_flux_down_1-above-surf_minus_toa_map_20140529_soc_minus_ukesm_szen_fix_clearclean.png', dpi = 300)
# plt.show()


# LW - alternative absorption check as ratio not difference between TOA and surf
# soc atmos abs plot 

# plt.figure()
# plt.title('lw up TOA/surf 20140529 Socrates szen fix clearclean')
# mesh = iplt.pcolormesh(soc_atmos_abs_lw_ratio,\
#                             # vmin = -140, vmax = 0,\
#                         cmap = 'viridis')
# plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
#                   orientation = 'horizontal',
#                     #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
#                   )
# plt.savefig(plot_dir + 'lw_flux_up_toa_div_surf_map_20140529_soc_szen_fix_clearclean.png', dpi = 300)
# plt.show()

# # ukesm atmos abs plot
# plt.figure()
# plt.title('lw up TOA/surf 20140529 UKESM szen fix clearclean')
# mesh = iplt.pcolormesh(ukesm_atmos_abs_lw_ratio,\
#                             # vmin = -140, vmax = 0,\
#                         cmap = 'viridis')
# plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
#                   orientation = 'horizontal',
#                     #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
#                   )
# plt.savefig(plot_dir + 'lw_flux_up_toa_div_surf_map_20140529_ukesm_szen_fix_clearclean.png', dpi = 300)
# plt.show()

# # soc-ukesm atmos abs plot
# plt.figure()
# plt.title('lw up TOA/surf 20140529 Socrates-UKESM szen fix clearclean')
# mesh = iplt.pcolormesh(diff_atmos_abs_lw_ratio,\
#                             # vmin = -1.5, vmax = 1.5,\
#                         cmap = 'seismic')
# plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
#                   orientation = 'horizontal',
#                     #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
#                   )
# plt.savefig(plot_dir + 'lw_flux_up_toa_div_surf_map_20140529_soc_minus_ukesm_szen_fix_clearclean.png', dpi = 300)
# plt.show()
