...
file_ukesm_data = file_loc.diag_dir + '/socrates_diags/cd964a.p620140529_daymn_clear_sky_flux.pp'

# file_soc_toa_sw = file_loc.diag_dir + '/socrates_diags/cd964_20140529_toa_sw_clear_sky_emis_sea_fix.nflx'
# file_soc_toa_lw = file_loc.diag_dir + '/socrates_diags/cd964_20140529_toa_lw_clear_sky_emis_sea_fix.nflx'

file_soc_toa_lw = file_loc.diag_dir + '/socrates_diags/cd964_20140529_toa_clear_sky_lw_aer_spline_bias_fix.nflx'
file_soc_toa_sw = file_loc.diag_dir + '/socrates_diags/cd964_20140529_toa_clear_sky_sw_aer_spline_bias_fix.nflx'
...
# ukesm plot
plt.figure()
plt.title('UKESM TOA net down flux 20140529 clear')
...
plt.savefig(plot_dir + 'net_flux_toa_map_20140529_ukesm_clear.png', dpi = 300)
plt.show() 

# ukesm plot sw 
plt.figure()
plt.title('UKESM TOA sw net down flux 20140529 clear')
mesh = iplt.pcolormesh(ukesm_net_toa_sw, vmin = 0, vmax = 450, cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_sw_flux_toa_map_20140529_ukesm_clear.png', dpi = 300)
plt.show() 

# ukesm plot lw
plt.figure()
plt.title('UKESM TOA lw net down flux 20140529 clear')
mesh = iplt.pcolormesh(ukesm_net_toa_lw, vmin = -400, vmax = -50, cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_lw_flux_toa_map_20140529_ukesm_clear.png', dpi = 300)
plt.show() 

# socrates plot
plt.figure()
plt.title('SOCRATES TOA net down flux 20140529 aer spline fix clear')
mesh = iplt.pcolormesh(soc_toa_net, vmin = -250, vmax = 250, cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_flux_toa_map_20140529_soc_aer_spline_fix_clear.png', dpi = 300)
plt.show()

# socrates plot sw
plt.figure()
plt.title('SOCRATES TOA sw net down flux 20140529 aer spline fix clear')
mesh = iplt.pcolormesh(soc_toa_sw, vmin = 0, vmax = 450, cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'sw_down_flux_toa_map_20140529_soc_aer_spline_fix_clear.png', dpi = 300)
plt.show()

# socrates plot lw
plt.figure()
plt.title('SOCRATES TOA lw net down flux 20140529 aer spline fix clear')
mesh = iplt.pcolormesh(soc_toa_lw, vmin = -400, vmax = -50, cmap = 'viridis')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'lw_down_flux_toa_map_20140529_soc_aer_spline_fix_clear.png', dpi = 300)
plt.show()
    
# difference plot
plt.figure()
plt.title('TOA net down flux 20140529 Socrates - UKESM aer spline fix clear')
mesh = iplt.pcolormesh(net_diff, vmin = -10, vmax = 10, cmap = 'seismic')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_flux_toa_map_20140529_soc-ukesm_aer_spline_fix_clear.png', dpi = 300)
plt.show()

# sw difference plot
plt.figure()
plt.title('TOA sw net down flux 20140529 Socrates - UKESM aer spline fix clear')
mesh = iplt.pcolormesh(net_diff_sw, vmin = -5, vmax = 5, cmap = 'seismic')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_sw_flux_toa_map_20140529_soc-ukesm_aer_spline_fix_clear.png', dpi = 300)
plt.show()

# lw difference plot
plt.figure()
plt.title('TOA lw net down flux 20140529 Socrates - UKESM aer spline fix clear')
mesh = iplt.pcolormesh(net_diff_lw, vmin = -10, vmax = 10, cmap = 'seismic')
plt.colorbar(mesh, shrink = 0.9, label = u'Flux / W m$^{-2}$', \
                  orientation = 'horizontal',
                   #ticks = [-0.02, -0.01, 0, 0.01, 0.02]
                  )
plt.savefig(plot_dir + 'net_lw_flux_toa_map_20140529_soc-ukesm_aer_spline_fix_clear.png', dpi = 300)
plt.show()
